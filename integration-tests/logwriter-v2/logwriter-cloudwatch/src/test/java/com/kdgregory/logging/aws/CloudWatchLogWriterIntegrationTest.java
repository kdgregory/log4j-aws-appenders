...
{
    private final static String BASE_LOGGROUP_NAME = "CloudWatchLogWriterV2IntegrationTest";

    // single "helper" client that's shared by all tests
    private static CloudWatchLogsClient helperClient;

    // this one is created by the "alternate region" tests
    private CloudWatchLogsClient altClient;

    // this client is used in testFactoryMethod(), should be null everywhere else
    private static CloudWatchLogsClient factoryClient;
...
//----------------------------------------------------------------------------
     ...
     *  default config.
     */
    private CloudWatchWriterConfig init(String testName, CloudWatchLogsClient client)
    throws Exception
    {
     ...
     */
    public static CloudWatchLogsClient staticClientFactory()
    {
        factoryClient = CloudWatchLogsClient.builder().build();
...
//----------------------------------------------------------------------------
    ...
    public void smoketest() throws Exception
    {
        ...
        assertNull("retention period not set", testHelper.describeLogGroup().retentionInDays());
    ...
    public void testFactoryMethod() throws Exception
    {
        ...
        Object client = ClassUtil.getFieldValue(facade, "client", CloudWatchLogsClient.class);
    ...
    public void testAlternateRegion() throws Exception
    {
        ...
        altClient = CloudWatchLogsClient.builder().region(Region.US_WEST_1).build();
    ...
    public void testRetentionPeriod() throws Exception
    {
        ...
        assertEquals("retention period", 3, testHelper.describeLogGroup().retentionInDays().intValue());
