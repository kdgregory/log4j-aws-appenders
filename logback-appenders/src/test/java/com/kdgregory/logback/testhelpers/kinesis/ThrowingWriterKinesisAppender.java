 ...
 */
public class ThrowingWriterKinesisAppender
extends TestableKinesisAppender
{
    public ThrowingWriterKinesisAppender()
    {
        super();
        setThreadFactory(new DefaultThreadFactory("test"));
        setWriterFactory(new ThrowingWriterFactory<KinesisWriterConfig,KinesisWriterStatistics>());
    }
}
