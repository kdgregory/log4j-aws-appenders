...
//----------------------------------------------------------------------------
            ...
            PutRecordsRequestEntry entry)
    {
        ...
        assertEquals(message + " content",
                     expectedMessage,
                     new String(entry.getData().array(), StandardCharsets.UTF_8));
    }
...
//----------------------------------------------------------------------------
    ...
    public void testPutRecordsHappyPath() throws Exception
    {
        ...
        assertPutRecordsRequestEntry("first record",    DEFAULT_PARTITION_KEY, "message 1", mock.putRecordsSourceRecords.get(0));
        assertPutRecordsRequestEntry("second record",   DEFAULT_PARTITION_KEY, "message 2", mock.putRecordsSourceRecords.get(1));
    ...
    public void testPutRecordsPartialFailure() throws Exception
    {
        mock = new KinesisClientMock(DEFAULT_STREAM_NAME)
        {
            ...
            {
                if (index % 2 == 0)
                    return new PutRecordsResultEntry().withErrorCode("ProvisionedThroughputExceededException");
                else
    ...
    public void testPutRecordsRandomPartitionKeys() throws Exception
    {
        ...
        String p1 = mock.putRecordsSourceRecords.get(0).getPartitionKey();
        String p2 = mock.putRecordsSourceRecords.get(1).getPartitionKey();
