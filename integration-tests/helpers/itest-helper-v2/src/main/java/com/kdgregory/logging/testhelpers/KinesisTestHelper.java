...
public class KinesisTestHelper
{
    ...
    public KinesisTestHelper(KinesisClient client, String testName)
    {
        this.client = client;
    ...
    public StreamDescription waitForStreamToBeReady() throws Exception
    {
        ...
        for (int ii = 0 ; ii < 60 ; ii++)
        {
            ...
            if ((desc != null) && (desc.streamStatus() == StreamStatus.ACTIVE))
            {
                return desc;
            }
        }
    ...
    public void deleteStreamIfExists() throws Exception
    {
        ...
        {
            DeleteStreamRequest request = DeleteStreamRequest.builder().streamName(streamName).build();
    ...
    public Map<String,String> getInitialShardIterators()
    {
        ...
        for (Shard shard : describeStream().shards())
        {
            ...
            GetShardIteratorRequest request = GetShardIteratorRequest.builder()
                                              ...
                                              .build();
            GetShardIteratorResponse response = client.getShardIterator(request);
            result.put(shardId, response.shardIterator());
        }
        return result;
    }
    ...
    throws Exception
    {
        GetRecordsRequest request = GetRecordsRequest.builder().shardIterator(shardItx).build();
    ...
    {
        assertEquals("shard count", expectedShardCount, describeStream().shards().size());
    }
    ...
    public void assertRetentionPeriod(Integer expectedRetentionPeriod) throws Exception
    {
        for (int ii = 0 ; ii < 60 ; ii++)
        {
            Integer actualRetentionPeriod = describeStream().retentionPeriodHours();
    ...
    public static class RetrievedRecord
    {
        ...
        throws Exception
        {
            ...
            this.message = record.data().asString(StandardCharsets.UTF_8).trim();
        }
    }
}
