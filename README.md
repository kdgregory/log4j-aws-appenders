...
* Log4J 2.x: 2.8
  This version added some convenience methods/constants that I found useful. Even
  without them, the earliest version that I could use was 2.7, which introduced a
  breaking change to `AbstractAppender`.
* Logback: 1.2.0
