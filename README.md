...
`discardThreshold`  | The threshold count for discarding messages; default is 10,000. See below for more information.
...
are persistent errors, such as a network outage, this could cause an out-of-memory error.
