...
//----------------------------------------------------------------------------
    ...
    public SsmClient createClient()
    {
        return (SsmClient)Proxy.newProxyInstance(
                            getClass().getClassLoader(),
                            new Class<?>[] { SsmClient.class },
                            SSMClientMock.this);
    }
...
//----------------------------------------------------------------------------
    ...
    public GetParameterResponse getParameter(GetParameterRequest request)
    {
        ...
        if (value == null)
            throw ParameterNotFoundException.builder().message(name).build();
        ...
        Parameter param = Parameter.builder()
                          ...
                          .value(value)
                          .build();
        return GetParameterResponse.builder().parameter(param).build();
    }
}
